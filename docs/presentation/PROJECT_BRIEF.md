# Project Brief: AI SIP PBX — 듣고, 이해하고, 처리하는 통화 비서
...
**AI SIP PBX**는 회사의 대표번호로 걸려 오는 전화와 문자에 사람처럼 응대하고,
...
AI SIP PBX는 고객의 말을 자연어로 듣고, 회사 지식을 검색하고, 필요한 업무를 직접 수행한 뒤,
...
AI SIP PBX는 통화 제어, AI 응대, 지식 운영, 사람 개입, 후속 안내를 **하나의 흐름으로 묶어서** 해결하는 데 초점을 둡니다.
...
> **고객 체감**: 메뉴를 외우지 않아도 되고, AI에게 말 끊는 것이 자연스럽습니다.
...
> **운영 체감**: 처음 한 달은 운영자 도움이 많지만, 시간이 지날수록 AI가 직접 답하는 비율이 높아집니다.
...
> **고객·상담원 체감**: 고객은 흐름이 끊기지 않고 안내를 받고, 상담원은 모든 전화를 받지 않아도 품질을 지킬 수 있습니다.
...
> **운영 체감**: "낮에는 사람, 점심·저녁은 AI, 휴일은 안내" 같은 정책을 코드 수정 없이 콘솔에서 구성합니다.

---

### 4.6 통화 연결음(컬러링) — 대기 시간을 브랜드 경험으로
...
> **고객 체감**: "전화가 끊긴 건 아닌가" 하는 불안을 줄이고, 첫인상을 브랜드 경험으로 만듭니다.
...
> **운영 체감**: 통화·문자·운영자 응답이 같은 채널에서 이어지므로 고객이 같은 설명을 반복하지 않습니다.
...
> **운영 체감**: "여보세요"부터 이미 누구인지·왜 전화했는지 알고 응대를 시작할 수 있습니다.
...
*본 문서는 AI SIP PBX 시스템의 대외 소개·발표용 Project Brief입니다.*
