...
| **초기 SW 개발** (본편) | **약 3.17억 원** | AI Call Agent **1.69억** (§5.2) + 기존 노드 **1.48억** (§5.3) |
| **합계** (STT CAPEX 제외) | **약 4.14억 원** | 권장 **약 3.8억 ~ 4.5억 원** |
| *(참고) STT CAPEX 포함 시* | *약 4.74억 원* | *본편 합계 + STT HW만* |
