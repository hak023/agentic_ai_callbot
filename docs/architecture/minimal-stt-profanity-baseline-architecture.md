...
| **STT** | **3** *(2+TB1)* | 운영 All-Active 2 + **TB 1** | RTP 직연·전사(자막·폭언 입력) | #1, #2 | **별도** §4.2 |
...
| **NLP·LLM** *(동일 호스트)* | 2 | 1 | **3** | 운영 All-Active + TB 1 | 32 vCPU, 256 GB RAM, **L40S×1**, HDD 2 TB, 1 Gbps | 약 3,804만 원 | **약 1억 1,412만 원** |
| **본편 합계** | 4 | 2 | **6대** | — | — | — | **약 1억 4,538만 원** |

### 4.2 STT 서버 (별도 산출 — 합계 미포함)

| 서버 종류 | 운영 | TB | **합계** | 이중화·비고 | 권장 스펙(노드당, 요약) | 노드당 ROM | 합계 ROM |
|-----------|------|-----|----------|-------------|-------------------------|------------|----------|
| **STT** | 2 | 1 | **3** | 운영 All-Active + TB 1 | 32 vCPU, 128 GB RAM, **L40S×1**, HDD 2 TB, 10 Gbps | 약 2,995만 원 | **약 8,985만 원** |
